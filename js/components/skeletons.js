export const skeletons = {
  ...
  matchList(count = 4) {
    const card = `<div class="card skel-match-card"><div class="skel-match-card__team"><div class="skel skel-circle skel-match-card__crest"></div><div class="skel skel-line skel-line--sm"></div></div><div class="skel skel-match-card__score"></div><div class="skel-match-card__team"><div class="skel skel-circle skel-match-card__crest"></div><div class="skel skel-line skel-line--sm"></div></div></div>`;
  ...
  eventList(count = 4) {
    const card = `<div class="card skel-event-card"><div class="skel skel-event-card__date"></div><div class="skel-event-card__body"><div class="skel skel-line skel-line--lg"></div><div class="skel skel-line skel-line--md"></div><div class="skel skel-line skel-line--sm"></div></div></div>`;
    return `<div class="flex flex-col gap-sm">${card.repeat(count)}</div>`;
  },
};
